...
public class MatDatePicker extends DatePicker {
    ...
    public MatDatePicker(Context context) {
        super(context);
        init(context);
    }

    public MatDatePicker(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init(context);
    }

    public MatDatePicker(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }
