...
/** Extends NumperPicker to apply the correct color to the dividers */
public class MatNumberPicker extends NumberPicker {

    private static final String DIVIDER_FIELD_NAME = "mSelectionDivider";

    public MatNumberPicker(Context context) {
        super(context);
        init(context);
    }

    public MatNumberPicker(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public MatNumberPicker(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void init(Context c) {
        try {
            ...
            int color = c.getResources().getColor(R.color.gm__picker_divider);
