...
/**
 * Overrides the AlertDialog to apply the Material style.
 * <br/><br/>
 * You can use the inner MatAlertDialog.Builder class to
 * create a dialog as you would with AlertDialog.Builder and 
 * the style will be correctly set.
 * <br/><br/>
 * Alternatively, you can use the default AlertDialog and
 * AlertDialog.Builder classes but you have to make sure to
 * apply the material style with DialogUtils. This must be
 * done AFTER showing the dialog.
 */
public class MatAlertDialog extends AlertDialog {

	protected MatAlertDialog(Context context) {
		super(context);
	}

	protected MatAlertDialog(Context context, boolean cancelable,
                             OnCancelListener cancelListener) {
		super(context, cancelable, cancelListener);
	}

	protected MatAlertDialog(Context context, int theme) {
		super(context, theme);
	}
        ...
        public AlertDialog create() {
            ...
            result.setOnShowListener(new OnShowListener() {
				...
				public void onShow(DialogInterface dialog) {
                    DialogUtils.prepareDialog(getContext(), result.getWindow());
				}
			});
            return result;
        }
